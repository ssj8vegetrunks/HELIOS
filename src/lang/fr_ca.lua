return {
    ...
    strings = {
        ...
        ["gui.modules_title"] = "MODULES GUI", ["gui.modules_subtitle"] = "Interfaces graphiques installees",
        ["gui.selected"] = "Selectionne", ["gui.module_id"] = "ID du module",
        ["gui.minimum_display"] = "Affichage minimum", ["gui.previous"] = "< PRECEDENT",
        ["gui.next"] = "SUIVANT >", ["gui.use"] = "UTILISER CE GUI",
        ["gui.install_github"] = "INSTALLER DEPUIS GITHUB", ["gui.install_title"] = "INSTALLER UN GUI DEPUIS GITHUB",
        ["gui.paste_folder"] = "Collez le lien du dossier GitHub contenant manifest.lua.",
        ["gui.example"] = "Exemple :", ["gui.inspecting"] = "Inspection du module GUI...",
        ["gui.name"] = "Nom", ["gui.version"] = "Version", ["gui.download"] = "Telechargement",
        ["gui.source"] = "Source", ["gui.confirm"] = "Installer ce GUI? Tapez OUI pour confirmer.",
        ["gui.trust_warning"] = "Installez seulement des GUI de developpeurs fiables. Le code GUI s'execute sur cet ordinateur.",
        ["gui.installed"] = "{name} a ete installe.", ["gui.install_failed"] = "Echec de l'installation : {reason}",
        ["gui.cannot_install"] = "Impossible d'installer ce GUI : {reason}",
        ["gui.install_cancelled"] = "Installation annulee.",
        ["gui.return"] = "Appuyez sur ENTREE pour revenir aux modules GUI.",
        ["log.mainframe_started"] = "Le serveur HELIOS {version} a demarre sur l'ordinateur {computer}",
        ["log.days"] = "VISIONNEUSE D'EVENEMENTS // JOURS", ["log.hours"] = "EVENEMENTS // {day} // HEURES",
        ["log.button"] = "VISIONNEUSE D'EVENEMENTS",
        ["log.events"] = "EVENEMENTS // {day} // {hour}", ["log.no_entries"] = "Aucune entree.",
