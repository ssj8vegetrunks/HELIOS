return {
    ...
    strings = {
        ...
        ["gui.modules_title"] = "GUI MODULES", ["gui.modules_subtitle"] = "Installed graphical interfaces",
        ["gui.selected"] = "Selected", ["gui.module_id"] = "Module ID",
        ["gui.minimum_display"] = "Minimum display", ["gui.previous"] = "< PREVIOUS",
        ["gui.next"] = "NEXT >", ["gui.use"] = "USE THIS GUI",
        ["gui.install_github"] = "INSTALL FROM GITHUB", ["gui.install_title"] = "INSTALL GUI FROM GITHUB",
        ["gui.paste_folder"] = "Paste the GitHub folder link containing manifest.lua.",
        ["gui.example"] = "Example:", ["gui.inspecting"] = "Inspecting GUI module...",
        ["gui.name"] = "Name", ["gui.version"] = "Version", ["gui.download"] = "Download",
        ["gui.source"] = "Source", ["gui.confirm"] = "Install this GUI? Type YES to confirm.",
        ["gui.trust_warning"] = "Only install GUIs from developers you trust. GUI code runs on this computer.",
        ["gui.installed"] = "Installed {name}.", ["gui.install_failed"] = "Installation failed: {reason}",
        ["gui.cannot_install"] = "Cannot install this GUI: {reason}",
        ["gui.install_cancelled"] = "Installation cancelled.",
        ["gui.return"] = "Press ENTER to return to GUI Modules.",
        ["log.mainframe_started"] = "HELIOS Mainframe {version} started on computer {computer}",
        ["log.days"] = "EVENT VIEWER // DAYS", ["log.hours"] = "EVENT VIEWER // {day} // HOURS",
        ["log.button"] = "EVENT VIEWER",
        ["log.events"] = "EVENT VIEWER // {day} // {hour}", ["log.no_entries"] = "No entries.",
