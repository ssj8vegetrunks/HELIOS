...
local translated = {
    ...
    ["gui.modules_title"]="MODULOS GUI", ["gui.modules_subtitle"]="Interfaces graficas instaladas",
    ["gui.selected"]="Seleccionado", ["gui.module_id"]="ID del modulo",
    ["gui.minimum_display"]="Pantalla minima", ["gui.previous"]="< ANTERIOR",
    ["gui.next"]="SIGUIENTE >", ["gui.use"]="USAR ESTA GUI",
    ["gui.install_github"]="INSTALAR DESDE GITHUB", ["gui.install_title"]="INSTALAR GUI DESDE GITHUB",
    ["gui.paste_folder"]="Pega el enlace de la carpeta de GitHub que contiene manifest.lua.",
    ["gui.example"]="Ejemplo:", ["gui.inspecting"]="Inspeccionando el modulo GUI...",
    ["gui.name"]="Nombre", ["gui.version"]="Version", ["gui.download"]="Descarga",
    ["gui.source"]="Origen", ["gui.confirm"]="Instalar esta GUI? Escribe SI para confirmar.",
    ["gui.trust_warning"]="Instala solo GUI de desarrolladores de confianza. El codigo se ejecuta en este ordenador.",
    ["gui.installed"]="Se instalo {name}.", ["gui.install_failed"]="Fallo la instalacion: {reason}",
    ["gui.cannot_install"]="No se puede instalar esta GUI: {reason}",
    ["gui.install_cancelled"]="Instalacion cancelada.",
    ["gui.return"]="Pulsa ENTER para volver a Modulos GUI.",
    ["log.mainframe_started"]="El ordenador central HELIOS {version} se inicio en el ordenador {computer}",
    ["log.days"]="VISOR DE EVENTOS // DIAS", ["log.hours"]="EVENTOS // {day} // HORAS",
    ["log.button"]="VISOR DE EVENTOS",
    ["log.events"]="EVENTOS // {day} // {hour}", ["log.no_entries"]="No hay entradas.",
