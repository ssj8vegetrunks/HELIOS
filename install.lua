...
local installerTranslations = {
    de_de = {
        ...
        ["guardian"] = "Drakonischer Waechter", ["profiler"] = "Drakonischer Profiler",
        ["reactor"] = "Reaktor", ["turbine"] = "Turbine", ["battery"] = "Energiespeicher",
        ["all"] = "Alle Systeme", ["Guardian computer ID"] = "Computer-ID des Waechters",
        ["Location"] = "Standort", ["Display"] = "Anzeige", ["installed successfully"] = "erfolgreich installiert",
        ["Module Pack"] = "Modulpaket", ["Previous version"] = "Vorherige Version",
        ["Upgrade mode: low-space (configuration/data preserved)"] = "Speichersparendes Upgrade (Konfiguration/Daten bleiben erhalten)",
        ["Industrial Power Management Suite"] = "Industrielle Energieverwaltung",
        ["Please enter a number from the list."] = "Bitte eine Nummer aus der Liste eingeben.",
        ["Select an installation category:"] = "Installationsart waehlen:",
        ["Install Mainframe"] = "Hauptrechner installieren", ["Install Remote Terminal"] = "Entferntes Terminal installieren",
        ["Modules"] = "Module", ["Select a module:"] = "Modul waehlen:",
        ["Hardware Probe (run once, read-only)"] = "Hardwarepruefung (einmalig, nur lesen)",
        ["Draconic Reactor Guardian"] = "Drakonischer Reaktorwaechter",
        ["Draconic Reactor Profiler (read-only)"] = "Drakonischer Reaktorprofiler (nur lesen)",
        ["Checking HELIOS Network"] = "HELIOS-Netzwerk wird geprueft",
        ["Looking for an existing mainframe..."] = "Vorhandener Hauptrechner wird gesucht...",
        ["No existing HELIOS mainframe found."] = "Kein vorhandener HELIOS-Hauptrechner gefunden.",
        ["Remote Terminal Configuration"] = "Konfiguration des entfernten Terminals",
        ["Select the information this terminal will request:"] = "Anzuzeigende Informationen waehlen:",
        ["Reactor"] = "Reaktor", ["Turbine"] = "Turbine", ["Battery"] = "Energiespeicher",
        ["All systems overview"] = "Uebersicht aller Systeme", ["Profiler Pairing"] = "Profiler-Kopplung",
        ["Enter the computer ID shown by the Draconic Guardian:"] = "Computer-ID des Drakonischen Waechters eingeben:",
        ["Guardian computer ID must be a whole number."] = "Die Computer-ID muss eine ganze Zahl sein.",
        ["Ready to Install"] = "Bereit zur Installation", ["Install HELIOS?"] = "HELIOS installieren?",
        ["Installation cancelled."] = "Installation abgebrochen.", ["Low-Space Upgrade"] = "Speichersparendes Upgrade",
        ["Not enough room for a second HELIOS copy."] = "Nicht genug Platz fuer eine zweite HELIOS-Kopie.",
        ["Preserving configuration and calibration data."] = "Konfiguration und Kalibrierdaten bleiben erhalten.",
        ["Replacing installed program files in place..."] = "Installierte Programmdateien werden ersetzt...",
        ["Installing Module Pack"] = "Modulpaket wird installiert",
        ["Downloading official peripheral modules..."] = "Offizielle Peripheriemodule werden heruntergeladen...",
        ["Installation Complete"] = "Installation abgeschlossen",
        ["HELIOS will start automatically after reboot."] = "HELIOS startet nach dem Neustart automatisch.",
        ["Run now with: helios"] = "Jetzt starten mit: helios",
        ["Check setup with: helios status"] = "Einrichtung pruefen mit: helios status",
        ["HELIOS installation failed:"] = "HELIOS-Installation fehlgeschlagen:",
        ["An existing /startup program was found."] = "Ein vorhandenes /startup-Programm wurde gefunden.",
        ["HELIOS can preserve it as /startup/00-user.lua."] = "HELIOS kann es als /startup/00-user.lua erhalten.",
        ["Convert startup to a startup directory?"] = "startup in ein Startverzeichnis umwandeln?",
    },
    fr_ca = {
...
local function confirm(prompt)
    ...
    return answer == "y" or answer == "yes" or
        ...
        (installerLanguage == "de_de" and (answer == "j" or answer == "ja")) or
...
return {
    ...
    strings = {
        ...
        ["guardian.core"] = "CORE", ["guardian.field"] = "FIELD", ["guardian.saturation_short"] = "SAT",
        ["guardian.reactor_telemetry"] = "REACTOR TELEMETRY", ["guardian.gate_control"] = "GATE CONTROL",
        ["guardian.export"] = "Export", ["guardian.gate_roles"] = "modem=field; {output}=export",
        ["guardian.auto_commission"] = "AUTO COMMISSION", ["guardian.commission_hint"] = "Starts at 50k RF/t; rises while the field stays at or above 17%.",
        ["guardian.initialize"] = "INITIALIZE & ACTIVATE", ["guardian.safe_shutdown"] = "SAFE SHUTDOWN",
        ["guardian.enable_assisted"] = "ENABLE ASSISTED MANUAL", ["guardian.recalibrate"] = "RECALIBRATE CEILING",
        ["guardian.recovery_complete"] = "Calibration recovery complete; export remains OFF", ["guardian.recovery_active"] = "Calibration recovery: output closed while containment rebuilds",
        ["guardian.commission_wait"] = "Automatic commissioning: waiting for reactor to reach ONLINE",
        ["guardian.commission_edge"] = "Calibration reached the 17% field edge; output closed. Last verified ceiling {ceiling} RF/t",
        ["guardian.commission_settle"] = "Waiting for {trial} RF/t to settle: reactor generation {generation} RF/t ({sample}/{total})",
        ["guardian.commission_complete"] = "Calibration complete: output path stopped accepting higher export; verified ceiling {ceiling} RF/t",
  ...
  if field>=LIFECYCLE_PROBE_FIELD and generation>=applied*.9 then
    ...
    if c.lifecycleSamples>=LIFECYCLE_PROOF_SAMPLES then
      if field>=c.lifecycleStartField-LIFECYCLE_FIELD_DRIFT then
        c.currentCycleCeilings[key]=math.max(tonumber(c.currentCycleCeilings[key]) or 0,applied)
...
local function lifecycleFieldTarget(c,r,baseline)
  ...
  c.lifecycleFieldApplied=applied
  return applied
end
...
local function supervise(b,d,c)
  ...
  if live then
    ...
    if c.request=="MAX" and not free then ceiling,note=lifecycleTarget(c,r);fieldTarget=lifecycleFieldTarget(c,r,injectorCap)
    else c.lifecycleApplied=nil;c.lifecycleSamples=0;c.lifecycleStartField=nil;c.lifecycleFieldApplied=nil;c.fieldTuneSamples=0;c.fieldTuneStart=nil end
    local target=ceiling*(FRACTION[c.request] or 0)
    gate(b.input,fieldTarget);gate(b.output,target)
