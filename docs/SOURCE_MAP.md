...
- `mainframe/main.lua` ← `src/mainframe/main.lua` (174439 bytes)
...
- `core/network.lua` ← `src/core/network.lua` (3383 bytes)
- `core/network_security.lua` ← `src/core/network_security.lua` (5270 bytes)
- `draconic/controller.lua` ← `draconic_guardian.lua` (89485 bytes)
...
- Kind: `hardware`
- Direct payload: 38563 bytes
- Required packages: `core`

- `modules/manifest.json` ← `module-pack/manifest.json` (1643 bytes)
...
- Kind: `gui`
- Direct payload: 16299 bytes
- Required packages: `core`

- `gui/control-room/manifest.lua` ← `src/gui/control-room/manifest.lua` (740 bytes)
