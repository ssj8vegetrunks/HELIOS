...
- `mainframe/main.lua` ← `src/mainframe/main.lua` (174025 bytes)
...
- `core/network.lua` ← `src/core/network.lua` (3383 bytes)
- `core/network_security.lua` ← `src/core/network_security.lua` (5270 bytes)
- `draconic/controller.lua` ← `draconic_guardian.lua` (87087 bytes)
...
- Kind: `gui`
- Direct payload: 16263 bytes
- Required packages: `core`

- `gui/control-room/manifest.lua` ← `src/gui/control-room/manifest.lua` (704 bytes)
