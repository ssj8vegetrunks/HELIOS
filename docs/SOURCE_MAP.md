...
- `core/network.lua` ← `src/core/network.lua` (3383 bytes)
- `core/network_security.lua` ← `src/core/network_security.lua` (5270 bytes)
- `draconic/controller.lua` ← `draconic_guardian.lua` (96275 bytes)
...
- Kind: `hardware`
- Direct payload: 38783 bytes
- Required packages: `core`

- `modules/manifest.json` ← `module-pack/manifest.json` (1863 bytes)
...
- Kind: `gui`
- Direct payload: 18247 bytes
- Required packages: `core`

- `gui/control-room/manifest.lua` ← `src/gui/control-room/manifest.lua` (920 bytes)
