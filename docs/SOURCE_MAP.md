...
- `mainframe/main.lua` ← `src/mainframe/main.lua` (174188 bytes)
...
- Kind: `gui`
- Direct payload: 16281 bytes
- Required packages: `core`

- `gui/control-room/manifest.lua` ← `src/gui/control-room/manifest.lua` (722 bytes)
