...
- `mainframe/reactor_governor.lua` ← `src/mainframe/reactor_governor.lua` (67905 bytes)
...
- `core/network.lua` ← `src/core/network.lua` (3383 bytes)
- `core/network_security.lua` ← `src/core/network_security.lua` (5270 bytes)
- `draconic/controller.lua` ← `draconic_guardian.lua` (97295 bytes)
...
- Kind: `hardware`
- Direct payload: 38849 bytes
- Required packages: `core`

- `modules/manifest.json` ← `module-pack/manifest.json` (1929 bytes)
...
- Kind: `gui`
- Direct payload: 18301 bytes
- Required packages: `core`

- `gui/control-room/manifest.lua` ← `src/gui/control-room/manifest.lua` (974 bytes)
