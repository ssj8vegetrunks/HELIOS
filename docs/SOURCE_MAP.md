...
- `core/network.lua` ← `src/core/network.lua` (3383 bytes)
- `core/network_security.lua` ← `src/core/network_security.lua` (5270 bytes)
- `draconic/controller.lua` ← `draconic_guardian.lua` (90235 bytes)
...
- Kind: `hardware`
- Direct payload: 38629 bytes
- Required packages: `core`

- `modules/manifest.json` ← `module-pack/manifest.json` (1709 bytes)
...
- Kind: `gui`
- Direct payload: 16353 bytes
- Required packages: `core`

- `gui/control-room/manifest.lua` ← `src/gui/control-room/manifest.lua` (794 bytes)
