...
- Kind: `hardware`
- Direct payload: 38497 bytes
- Required packages: `core`

- `modules/manifest.json` ← `module-pack/manifest.json` (1577 bytes)
...
- Kind: `gui`
- Direct payload: 16245 bytes
- Required packages: `core`

- `gui/control-room/manifest.lua` ← `src/gui/control-room/manifest.lua` (686 bytes)
