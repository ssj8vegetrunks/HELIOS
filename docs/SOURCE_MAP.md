...
- `mainframe/main.lua` ← `src/mainframe/main.lua` (174763 bytes)
...
- `core/network.lua` ← `src/core/network.lua` (3383 bytes)
- `core/network_security.lua` ← `src/core/network_security.lua` (5270 bytes)
- `draconic/controller.lua` ← `draconic_guardian.lua` (89927 bytes)
...
- Kind: `hardware`
- Direct payload: 38585 bytes
- Required packages: `core`

- `modules/manifest.json` ← `module-pack/manifest.json` (1665 bytes)
...
- Kind: `gui`
- Direct payload: 16317 bytes
- Required packages: `core`

- `gui/control-room/manifest.lua` ← `src/gui/control-room/manifest.lua` (758 bytes)
