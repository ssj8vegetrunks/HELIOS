...
- `core/network.lua` ← `src/core/network.lua` (3383 bytes)
- `core/network_security.lua` ← `src/core/network_security.lua` (5270 bytes)
- `draconic/controller.lua` ← `draconic_guardian.lua` (93098 bytes)
...
- Kind: `hardware`
- Direct payload: 38717 bytes
- Required packages: `core`

- `modules/manifest.json` ← `module-pack/manifest.json` (1797 bytes)
...
- Kind: `gui`
- Direct payload: 18193 bytes
- Required packages: `core`

- `gui/control-room/manifest.lua` ← `src/gui/control-room/manifest.lua` (866 bytes)
