...
- Kind: `hardware`
- Direct payload: 38651 bytes
- Required packages: `core`

- `modules/manifest.json` ← `module-pack/manifest.json` (1731 bytes)
...
- Kind: `gui`
- Direct payload: 16371 bytes
- Required packages: `core`

- `gui/control-room/manifest.lua` ← `src/gui/control-room/manifest.lua` (812 bytes)
- `gui/control-room/renderer.lua` ← `src/gui/control-room/renderer.lua` (15559 bytes)
