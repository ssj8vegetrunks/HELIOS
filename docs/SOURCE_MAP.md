...
- `mainframe/main.lua` ← `src/mainframe/main.lua` (179110 bytes)
- `mainframe/manual_control.lua` ← `src/mainframe/manual_control.lua` (1990 bytes)
- `mainframe/reactor_governor.lua` ← `src/mainframe/reactor_governor.lua` (68270 bytes)
- `mainframe/turbine_governor.lua` ← `src/mainframe/turbine_governor.lua` (48565 bytes)
...
- `core/network.lua` ← `src/core/network.lua` (3383 bytes)
- `core/network_security.lua` ← `src/core/network_security.lua` (5270 bytes)
- `draconic/controller.lua` ← `draconic_guardian.lua` (102548 bytes)
...
- Kind: `hardware`
- Direct payload: 39091 bytes
- Required packages: `core`

- `modules/manifest.json` ← `module-pack/manifest.json` (2171 bytes)
...
- Kind: `gui`
- Direct payload: 18499 bytes
- Required packages: `core`

- `gui/control-room/manifest.lua` ← `src/gui/control-room/manifest.lua` (1172 bytes)
