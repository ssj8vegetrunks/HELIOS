...
- Kind: `hardware`
- Direct payload: 38827 bytes
- Required packages: `core`

- `modules/manifest.json` ← `module-pack/manifest.json` (1907 bytes)
...
- Kind: `gui`
- Direct payload: 18283 bytes
- Required packages: `core`

- `gui/control-room/manifest.lua` ← `src/gui/control-room/manifest.lua` (956 bytes)
