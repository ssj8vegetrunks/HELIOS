...
1. Expand the seven-day Event Viewer from its completed archive/viewer foundation to reactor, turbine, storage, alarm, networking, and operator-action events
